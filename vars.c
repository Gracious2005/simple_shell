 ...
 * @info: represents parameter structure
 * @buf: represents char buffer
 * @p: address of position in buffer
 *
 * Return: 1 if chain delimeter, 0 if not chain delimeter
 */
...
/**
 * check_chain - checks if chaining continues
 ...
 * @old: address of former or older  string
 * @new: latest or new string
 *
