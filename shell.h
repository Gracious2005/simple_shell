...
/**
 * struct passinfo - provides fictitious arguments that may
*  be used to call a function, allowing a consistent prototype
 ...
 * @environ: customized version of environ from LL env
 ...
 * @readfd:  filedescriptor from which to read line input from
